...
public class Overload {
    ...
    private static void printAngka(double angkaDouble){
        ...
        System.out.println("Angka double dengan nilai = " + angkaDouble);
    }

    private static void printAngka(float angkaFloat){

        System.out.println("Angka float dengan nilai = " + angkaFloat);
    }

    private static void printAngka(int angkaInteger){

        System.out.println("Angka integer dengan nilai = " + angkaInteger);
    }
}
